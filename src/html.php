 ...
 */
function maxValue($var)
{
	if(isset($_REQUEST[$var]))
	{
		$val = intval($_REQUEST[$var]);
		if($var == "columns" && $val < 10)
			return true;
		else if($var == 'rows' && $val < 20)
			return true;
	}
	return false;
}
...
<div class='noprint'>
	...
	<p><a href='http://github.com/pieterhoekstra/barpdf'>Download</a> <a href='javascript:toggleDetectClipping()'>Detecteer clipping <span id='clipping'></span></a>
	<form action='?'>
